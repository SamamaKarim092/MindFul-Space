...
function initPhoneMockup() {
    ...
    setInterval(() => {
        ...
        const randomCircle = moodCircles[Math.floor(Math.random() * moodCircles.length)];
...
function initRevealAnimations() {
    const revealElements = document.querySelectorAll('.feature-card, .about-stat, .journey-step');
