      ...
      <div className="max-w-6xl mx-auto px-6 py-20">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-20">
          ...
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 hover:bg-white/20 transition-all">
            ...
            <p className="text-white/80">
              Visualize your emotional patterns over time with beautiful charts
              and insights. Understand what affects your wellbeing.
            </p>
          </div>
          ...
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 hover:bg-white/20 transition-all">
            ...
            <p className="text-white/80">
              Talk to an understanding AI coach anytime. Get supportive guidance
              and coping strategies when you need them most.
            </p>
          </div>
        </div>
        ...
        <footer className="py-12 text-center text-white/70">
          <p>
            © {new Date().getFullYear()} MindJournal. Your mental health
            matters.
          </p>
