                ...
                {isLoading ? (
                  ...
                  <>
                    ...
                    <motion.button
                      ...
                      whileTap={{ scale: 0.98 }}
                      onClick={onTalkClick}
                      className="w-full py-3 px-4 rounded-xl text-white font-medium flex items-center justify-center gap-2 transition-all shadow-lg bg-gradient-to-r from-purple-500 to-pink-500 hover:brightness-110"
                    >
