const fs = require("fs");
const file =
  "e:/Git Hub/Mental-Health-Sentiment-Journal/src/app/components/about/ProductPillars.tsx";
                  ...
                  >
                    <motion.div
                      style={{
                        y: useTransform(
                          objectPositionY,
                          (val) => \`calc(\${val} - 50%)\`, // Simulating the image object-position shift via Y translate
                        ),
                      }}
