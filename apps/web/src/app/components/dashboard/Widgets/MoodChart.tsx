...
const GET_MOOD_TRENDS = gql`
  query GetMoodTrends($days: Int!) {
    moodTrends(days: $days) {
      date
      positiveCount
      neutralCount
      negativeCount
...
export default function MoodChart() {
  ...
  const { data, loading, error } = useQuery(GET_MOOD_TRENDS, {
    variables: { days },
