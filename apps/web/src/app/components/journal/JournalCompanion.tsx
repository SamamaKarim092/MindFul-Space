...
export default function JournalCompanion() {
  ...
  useEffect(() => {
    ...
    window.addEventListener("wordCountUpdate", (e: any) => {
  ...
  const getCompanionColor = () => {
    switch (mood) {
      ...
      case "ANXIOUS":
        return "from-purple-400 to-lavender-600";
      case "ENERGETIC":
  ...
  return (
    <div className="relative flex flex-col items-center">
      ...
      <motion.div
        ...
        transition={{ duration: 1.5, repeat: mood === "GRATEFUL" ? Infinity : 0 }}
      ...
      <motion.div
        ...
        transition={{ duration: 1.5, repeat: mood === "GRATEFUL" ? Infinity : 0, delay: 0.5 }}
        ...
        <div className="relative w-full h-full flex items-center justify-center">
          ...
          <div className="absolute top-[35%] w-full flex justify-center gap-6">
            ...
            <motion.div
              ...
              animate={mood}
              variants={{
                NEUTRAL: { height: 8, width: 8, borderRadius: "50%", scaleY: 1 },
                HAPPY: { height: 8, width: 8, borderRadius: "50%", scaleY: 1, y: -2 },
                SAD: { height: 8, width: 8, borderRadius: "50%", scaleY: 1, rotate: -15 },
                ANXIOUS: { height: 10, width: 10, borderRadius: "50%", scaleY: 1 },
                ENERGETIC: { height: 12, width: 12, borderRadius: "50%", scaleY: 1, y: -2 },
                CALM: { height: 3, width: 10, borderRadius: "10px", scaleY: 0.5, rotate: 0 }, // Closed/Relaxed
                GRATEFUL: { height: 6, width: 8, borderRadius: "50% 50% 50% 50%", scaleY: 0.7, y: -1, rotate: -20 }, // Heart-like squinted eyes
              }}
          ...
          <motion.div
            ...
            variants={{
              NEUTRAL: { 
                width: 20, height: 4, borderRadius: "4px", y: 20, rotate: 0 
              },
              HAPPY: { 
                width: 24, height: 12, borderRadius: "0 0 12px 12px", y: 20, rotate: 0 
              },
              SAD: { 
                width: 20, height: 8, borderRadius: "12px 12px 0 0", y: 24, rotate: 0 
              },
              ANXIOUS: { 
                width: 10, height: 6, borderRadius: "50%", y: 22, rotate: 0,
                scale: [1, 1.2, 1], // Nervous breathing effect
                transition: { repeat: Infinity, duration: 1 }
              },
              ENERGETIC: { 
                width: 28, height: 14, borderRadius: "0 0 14px 14px", y: 20, rotate: -5 
              },
              CALM: { 
                width: 18, height: 6, borderRadius: "0 0 10px 10px", y: 22, rotate: 0 
              },
              GRATEFUL: { 
                width: 26, height: 8, borderRadius: "0 0 14px 14px", y: 18, rotate: 0 // Wider, gentler smile
              }
            }}
            transition={{ type: "spring", stiffness: 300, damping: 20 }}
